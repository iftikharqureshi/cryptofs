...
public class CryptoDirectoryStreamProviderTest {
	...
	private final CryptoDirectoryStreamProvider inTest = new CryptoDirectoryStreamProvider(cryptor, longFileNameProvider, conflictResolver, cryptoPathMapper, finallyUtil, encryptedNamePattern);
