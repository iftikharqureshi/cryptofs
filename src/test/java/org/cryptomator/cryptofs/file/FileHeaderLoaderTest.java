...
import org.cryptomator.cryptofs.file.FileHeaderLoader;
...
public class FileHeaderLoaderTest {
	...
	static {
		System.setProperty("org.slf4j.simpleLogger.log.org.cryptomator.cryptofs.file.FileHeaderLoader", "trace");
