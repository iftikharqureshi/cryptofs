...
import static org.cryptomator.cryptofs.paths.CiphertextDirectoryDeleter.DeleteResult.NO_FILES_DELETED;
import static org.cryptomator.cryptofs.paths.CiphertextDirectoryDeleter.DeleteResult.SOME_FILES_DELETED;
...
public class CiphertextDirectoryDeleter {
	...
	@Inject
	public CiphertextDirectoryDeleter(CryptoDirectoryStreamProvider directoryStreamProvider) {
	...
	private Set<Path> ciphertextFiles(CryptoPath cleartextDir) throws IOException {
		try (CryptoDirectoryStream directoryStream = directoryStreamProvider.newDirectoryStream(cleartextDir, ignored -> true)) {
