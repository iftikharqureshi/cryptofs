...
public class CryptoFileSystemProperties extends AbstractMap<String, Object> {
	...
	public static final String DEFAULT_MASTERKEY_FILENAME = "masterkey.cryptomator";
	...
	public static final Set<FileSystemFlags> DEFAULT_FILESYSTEM_FLAGS = unmodifiableSet(EnumSet.of(FileSystemFlags.MIGRATE_IMPLICITLY, FileSystemFlags.INIT_IMPLICITLY));
